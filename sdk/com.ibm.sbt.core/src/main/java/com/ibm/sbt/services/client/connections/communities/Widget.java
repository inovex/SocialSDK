/*
 * Copyright inovex GmbH, Robert Bosch Stiftung 2014
 */
...
import com.ibm.sbt.services.client.connections.communities.transformers.WidgetTransformer;
...
public class Widget extends BaseEntity {
	...
	public Widget(WidgetCommunityService svc, DataHandler<?> handler)
	{
		super(svc,handler);
	}
	...
	private String createWidgetRequestPayload() throws TransformerException {
		WidgetTransformer transformer = new WidgetTransformer(this);
