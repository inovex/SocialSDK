...
import com.ibm.sbt.services.client.connections.communities.transformers.WidgetCommunityTransformer;
...
public class WidgetCommunity extends Community {
	...
	public String getParentCommunityUrl() {
		return getAsString(WidgetCommunityXPath.parentCommunityUrl);
	}
	
	public void setParentCommunityUrl(String url) {
		setAsString(WidgetCommunityXPath.parentCommunityUrl, url);
	}
	...
	private String createCommunityRequestPayload() throws TransformerException {
		WidgetCommunityTransformer transformer = new WidgetCommunityTransformer(this);
